...
$service->setSearchPreferences(false, 150);
...
//date search:  creates a date record referencing all items after $days_to_update ago.
//i.e.  if $days_to_update=2 & today is 10/9/2014 XX:XX:XX references all dates after 10/7/2009 XX:XX:XX
$days_to_update = 730;
